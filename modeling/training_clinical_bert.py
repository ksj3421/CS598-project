...
class AbstractTrainer():
    ...
    def train_one_epoch(self, epoch):
        ...
        for step, batch in enumerate(self.train_dataloader):
            ...
            loss, logits = self.classifier(input_ids, attention_mask=input_mask, token_type_ids=segment_ids, labels=label_ids)
            if self.n_gpu > 1:
    ...
    def evaluate(self, epoch, dataloader, df_test, eval_type='val'):
        ...
        for step, batch in enumerate(dataloader): 
            ...
            input_ids, input_mask, segment_ids, label_ids = batch
            with torch.no_grad():
                tmp_eval_loss, temp_logits = self.classifier(input_ids, attention_mask=input_mask,
